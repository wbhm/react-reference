# Reference App for [Building Applications in React and Redux in ES6]

## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows](https://github.com/coreybutler/nvm-windows)
2. **Clone this repository.** - `git clone https://github.com/wbhm/react-reference.git` or [download the zip](https://github.com/wbhm/react-reference.git/archive/master.zip)
3. **Make sure you're in the directory you just created.** - `cd react-reference`
